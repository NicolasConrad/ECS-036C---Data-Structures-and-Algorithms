 ...
 * 3) There is at least one edge with weight 0.
 *      - Runtime error message: "Detected edge weight of 0."
 * 4) There is at least one Edge with a @from or @to member
 ...
 * 5) There is at least one self-loop.
 *      - Runtime error message: "At least one self-loop."
 * 6) There is at least one occurrence of multi-edges.
 *      - Runtime error message: "Detected multi-edges."
 * 7) The flow network does not contain only one source.
 *      - Runtime error message: "Zero or more than one source."
 * 8) The flow network does not contain only one sink.
